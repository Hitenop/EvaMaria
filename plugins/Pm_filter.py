...
async def cb_handler(client: Client, query: CallbackQuery):
    ...
    if query.data.startswith("file"):
        ...
        buttons = [[
            InlineKeyboardButton('➕ Add me to your group ➕', url='http://t.me/mpfiterbot?startgroup=true')
            ],[
        ...
        buttons= [[
            InlineKeyboardButton('➕ Add me to your group ➕', url='http://t.me/mpfilterbot?startgroup=true')
            ],[
            InlineKeyboardButton('Updates', url='https://t.me/moviezzprime'),
            InlineKeyboardButton('Support', url='https://t.me/requestprime')
            ],[
...
async def advantage_spell_chok(msg):
    ...
    if movielist:
        one_button = InlineKeyboardMarkup([[InlineKeyboardButton("Check spelling", url="https://www.google.com/search?q=")]])
    ...
    if not movielist:
        one_button = InlineKeyboardMarkup([[InlineKeyboardButton(" Check Spelling", url="https://www.google.com/search?q=")]])
        k = await msg.reply_photo(photo="https://telegra.ph/file/90774d8c83299d11b2199.jpg", caption="<b>Hey, 𝐒𝐨𝐫𝐫𝐲, 𝐍𝐨 𝐌𝐨𝐯𝐢𝐞/𝐒𝐞𝐫𝐢𝐞𝐬 𝐑𝐞𝐥𝐚𝐭𝐞𝐝 𝐓𝐨 𝐓𝐡𝐞 𝐆𝐢𝐯𝐞𝐧 𝐖𝐨𝐫𝐝 𝐖𝐚𝐬 𝐅𝐨𝐮𝐧𝐝 🥺</b>\n\n<b>𝙿𝚘𝚜𝚜𝚒𝚋𝚕𝚎 𝙲𝚊𝚞𝚜𝚎𝚜 : 🤔</b>\n\n<b>⭕️ 𝐍𝐨𝐭 𝐑𝐞𝐥𝐞𝐚𝐬𝐞𝐝 𝐘𝐞𝐭\n⭕️ 𝐈𝐧𝐜𝐨𝐫𝐫𝐞𝐜𝐭 𝐒𝐩𝐞𝐥𝐥𝐢𝐧𝐠\n⭕ 𝐍𝐨𝐭 𝐔𝐩𝐥𝐨𝐚𝐝𝐞𝐝 𝐁𝐲 𝐎𝐰𝐧𝐞𝐫\n\n<b>Check Spelling</b>", reply_markup = one_button)
        await asyncio.sleep(20)
        await k.delete()
        return
